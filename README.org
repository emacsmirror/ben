...
*BEn* stands for *Buffer ENvironments*, it's an asynchronous fork of [[https://github.com/purcell/envrc][envrc]].
...
This is main feature of 'ben'. It prevents Emacs from freezing while loading
...
(use-package ben
  :vc (:url "https://codeberg.org/pastor/ben")
  :bind
